...
public class FestasController{
     ...
     public static File UPLOAD_FILE = new File("/home/thiago/Desenvolvimento/workspace_gosfest_mvn/gofest-site/src/main/java/com/tocolado/site/util/Episodeo.java");
     ...
     public static void main(String[] args) throws GeneralSecurityException, IOException, ServiceException {
          ...
          insertFile(drive, "upload", "arquivo feito upload no java", FOLDER_ID, TipoDeArquivo.TXT.getTipoDeArquivo(), "/home/thiago/Desenvolvimento/workspace_gosfest_mvn/gofest-site/src/main/java/com/tocolado/site/util/Episodeo.java");
     ...
     private static com.google.api.services.drive.model.File insertFile(Drive service, String title, String description, String parentId, String mimeType, String filename) {
     ...
     private static com.google.api.services.drive.model.File insertFile(Drive service, String title, String description, String parentId, String mimeType, InputStream inputStream) {
